...
// the coarse state banding used to color the HUD.
import { responseDamage as sharedResponseDamage, vitalsFromDamage, VITALS_BAND_COST, VITALS_RESTART_THRESHOLD } from "../../../shared/vitals.js";

export const RESTART_THRESHOLD = VITALS_RESTART_THRESHOLD;
...
export const vitalsStateFrom = cumulativeDamage => {
  ...
  if (cumulativeDamage < VITALS_RESTART_THRESHOLD) return "two_errors";
  return "critical";
};
